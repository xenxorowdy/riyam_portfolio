  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-400/10 to-black">
      ...
      <div className="animate-fade-in py-3">
        <h3 className="text-xl font-semibold text-zinc-200 my-2 left-0">
          Expirence
        </h3>
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="border border-zinc-700 rounded-lg p-6 bg-gradient-to-b from-zinc-900/50 to-zinc-900/30">
            <h3 className="text-xl font-semibold text-zinc-200 mb-4">
              Dentira{" "}
              <span className="text-zinc-500 font-normal">• SDE-II</span>
            </h3>
